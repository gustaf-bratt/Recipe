...
//    self.flipsideViewController.view.frame = CGRectMake(0, 20, self.flipsideViewController.view.frame.size.width, self.flipsideViewController.view.frame.size.height);
